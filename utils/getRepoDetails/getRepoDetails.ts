...
export const getRepoDetails = async (
  { username, repo }: GetRepoDetailsProps
): Promise<RepoDetailsResponseProps | undefined> => {
  try {
    ...
    const { description, stargazers_count }: RepoDetailsResponseProps = await response.json()
